/*!
 * rcm-llm.js — طبقة التوليد اللغوي في «مساند نماء الذكي»
...
(function (root) {
  ...
  // ────────────────────────────────────────────────────────────────
  var SYSTEM = [
    "أنت «مساند نماء الذكي»، المساعد المرجعي في منصّة «مُتَنَبِّئ نماء» بتجمع مكة المكرمة الصحي —",
    ...
    "• حين تُرفَق حالة من نموذج مُتَنَبِّئ نماء، اقرأ أسباب عدم اكتمال الموافقة المتوقَّعة،",
