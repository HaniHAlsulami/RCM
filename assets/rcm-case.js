...
(function (root) {
  ...
  var REASON_MAP = {
    DUPLICATE: {
      ...
      check: "هل تحقّقت من عدم وجود موافقة أو طلب سابق بنفس رمز الخدمة والتاريخ لهذا المستفيد؟",
    },
    ELIGIBILITY: {
    ...
    LATE_SUBMISSION: {
      query: "مدة رفع الطلب والمطالبة والإشعار المهلة النظامية تأخر التقديم",
